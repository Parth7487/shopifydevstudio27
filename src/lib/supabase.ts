...
const enableSupabase =
  String(import.meta.env.VITE_ENABLE_SUPABASE || "").toLowerCase() === "true";
...
if (hasValidCredentials) {
  ...
  console.info(
    "Supabase disabled or not configured. Set VITE_ENABLE_SUPABASE=true, VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to enable database features.",
  );
}
